            ...
            <Head title="Welcome" />
                    ...
                    <header className='sticky top-0 z-10 flex-row w-full py-4 border-b-2 shadow-lg bg-white/60 padding-x backdrop-blur-lg border-neutral-300/30 '>
                        ...
                        <main className="bg-white h-screen w-full overflow-hidden mx-auto">
                            ...
                            <div className="grid justify-center w-5/6 h-full gap-3 mx-auto container-2xl">
                                <div className="col-span-2 gap-4 p-8 text-center">
                                    <h1 className="pb-5 font-sans text-6xl w-max font-bold text-green-700">
                                        About Us </h1>
